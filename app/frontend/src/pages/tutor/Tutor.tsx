...
const Tutor = () => {
    ...
    const EXAMPLES: ExampleModel[] = [
        {
            text: "Determine the slope of the line passing through the points (2,5)(2,5) and (4,9)(4,9)",
            value: "Determine the slope of the line passing through the points (2,5)(2,5) and (4,9)(4,9)"
        },
        ...
        {
            text: "Find the mean height of students in centimeters: 160, 165, 170, 175, 180.",
            value: "The heights (in centimeters) of students in a class are recorded as follows: 160, 165, 170, 175, 180. Find the mean height of the students."
        }
    ];
    ...
    return (
        <div className={styles.App}>
            <MathFormatProfessionalFilled fontSize={"6rem"} primaryFill={"navy"} aria-hidden="true" aria-label="Supported File Types" />
            <h1 className={styles.title}>Math Assistant</h1>
            <span className={styles.chatEmptyObjectives}>
                <i className={styles.centered}>Information Assistant uses AI. Check for mistakes.</i>{" "}
            ...
            <div className={styles.centeredContainer}>
                <p style={{ color:'navy'}}>Select an example query:</p>
                <div>
                ...
                <form className={styles.formClass} onSubmit={handleInput}>
                    ...
                    <div className={styles.buttonContainer}>
                        ...
                        <button
                            ...
                            className={selectedButton === "button1" ? styles.selectedButton : styles.analysisButtons}
                            onClick={() => {
                                setSelectedButton("button1");
                                hinter(mathProblem);
                            }}
                        ...
                        <button
                            ...
                            className={selectedButton === "button2" ? styles.selectedButton : styles.analysisButtons}
                            onClick={() => {
                                setSelectedButton("button2");
                                // solver(mathProblem);
                                handleButton2Click();
                        ...
                        <button
                            ...
                            className={selectedButton === "button3" ? styles.selectedButton :styles.analysisButtons}
                            onClick={() => {
                                setSelectedButton("button3");
                                getAnswer(mathProblem);
                            }}
                ...
                {renderAnswer && !error && (
                    <CharacterStreamer
                        ...
                        onStreamingComplete={handleCloseEvent}
                        classNames={styles.centeredAnswerContainer}
                        nonEventString={output}
                    />
                )}
            </div>
        </div>

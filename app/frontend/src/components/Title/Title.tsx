...
export const Title = () => {
    ...
    return (
        <>
            ...
            {/* This is the real logic that will get the title from the api above is just for testing purposes */}
            {Title?.APPLICATION_TITLE?Title?.APPLICATION_TITLE:"Information Assistant for the Web"}
        </>
    );
};
